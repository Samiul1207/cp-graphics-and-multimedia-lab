...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "0432320005101060", NULL, NULL);
    if (window == NULL)
    {
    ...
    // Center fill triangle 1
    -0.15f, 0.2f, 0.0f,
     0.15f, 0.2f, 0.0f,
     0.0f, -0.2f, 0.0f,

    // Center fill triangle 2
    -0.15f,-0.2f, 0.0f,
     0.15f,-0.2f, 0.0f,
     0.0f,  0.2f, 0.0f   
    }; 
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawArrays(GL_TRIANGLES, 0, 18); //0 starting index, 3 no. of vertices
